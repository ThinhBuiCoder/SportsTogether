...
function sortProducts(event) {
    ...
    $.ajax({
        url: "/PRJ301_Sp25_SportsTogether/ShopServlet",
        type: "get",
        data: {
            valueSort: text
        },
...
function searchProducts(tag, scope) {
    ...
    var scope = scope;
    $.ajax({
        url: "/PRJ301_Sp25_SportsTogether/SearchServlet",
        type: "get",
        data: {
            txtSearch: text,
            scope: scope
...
function addProductToCart(action, product_id, quantity) {
    ...
    var sl = quantity;
    $.ajax({
        url: "/PRJ301_Sp25_SportsTogether/CartServlet",
        type: "get",
        data: {
            action: action,
...
function addProductToWishlist(action, product_id) {
    ...
    var productId = product_id;
    $.ajax({
        url: "/PRJ301_Sp25_SportsTogether/WishlistServlet",
        type: "get",
        data: {
            action: action,
            product_id: productId,
...
function checkDuplicate(input) {
    ...
    $.ajax({
        url: "/PRJ301_Sp25_SportsTogether/RegisterServlet",
        type: "post",
        data: {
            username: username,
...
function subscribeEmailAtHome(action) {
    ...
    var action = action;
    $.ajax({
        url: "/PRJ301_Sp25_SportsTogether/EmailServlet",
        type: "get",
        data: {
            email: email,
            action: action
